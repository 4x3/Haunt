...
const murderMystery = {
  ...
  fields(s) {
    ...
    return [
      ...
      field('Bows Shot', count(num(s, 'bow_shots'))),
      field('Coins', count(num(s, 'coins'))),
    ];
  },
};
...
const blitz = {
  ...
  fields(s) {
    return [
      ...
      field('Deaths', count(num(s, 'deaths'))),
      field('K/D', kd(s)),
      field('Games', count(num(s, 'games_played'))),
...
const pit = {
  ...
  fields(s) {
    ...
    return [
      ...
      field('Gold', count(num(profile, 'cash'))),
