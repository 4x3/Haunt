...
* **Comprehensive Player Profiles:** Retrieve overall Hypixel network levels, active guild affiliations, UUID conversions, and complete Minecraft name histories.
...
* `skin`, `capes`, `names`, `uuid` - Mojang account data and visual renders.
...
* Hypixel API Key (Generated in-game via `/api`)
...
### 2. Environment Setup
Configure your environment variables. Create a `.env` file in the root directory and input your credentials:
